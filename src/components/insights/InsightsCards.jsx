...
function InsightsCards(props) {
    ...
    return (
        <div className="lg:w-[340px] w-[280px] lg:h-[510px] h-[460px] relative flex items-end justify-center ">
            ...
            <div className=" lg:w-[340px]  w-[280px] bg-white dark:bg-black bg-opacity-5 backdrop-blur-xl dark:bg-opacity-5 dark:backdrop-blur-xl  opacity-95 rounded-[10px] p-4 m-2 relative text-justify h-[250px]">
                ...
                <div className='flex items-start justify-between mt-2'>
                            <div className="flex text-justify"><span className="text-black dark:text-white  text-[11px] font-bold font-['Inter'] ">Category - </span><span className="text-black dark:text-white text-[11px] font-normal font-['Inter'] ">Lorem ipsum</span></div>
                            <div className="flex text-justify"><span className="text-black dark:text-white  text-[11px] font-bold font-['Inter'] ">Date - </span><span className="text-black dark:text-white  text-[11px] font-normal font-['Inter'] ">DD/MM/YYYY</span></div>
                        </div>
