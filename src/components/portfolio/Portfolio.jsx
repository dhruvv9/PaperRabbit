...
function Portfolio() {
    return (
        <div className="flex items-center justify-center h-screen">
            <div className="w-[1920px] h-[1020px] px-[250px] pt-[19px] pb-[29px] flex-col justify-start items-center gap-[50px] inline-flex">

                <div className="self-stretch h-32 relative flex justify-center items-center">
                    <div className=" text-center text-sky-200 text-8xl font-normal font-['Heaven'] leading-[64px]">Showcase</div>
                    <div className=" text-center pb-10 text-black text-[64px] font-normal font-['Revelstoke'] leading-[64px]">Portfolio</div>
                </div>

                <div className="w-[1420px] h-[700px] relative">
                    <div className="w-[700px] h-[340px] left-0 top-0 absolute">
                        <img className="w-[700px] h-[340px] left-0 top-0 absolute rounded-[20px]" src={portfolio1} alt='' />
                        <div className="w-[700px] h-80 left-0 top-0 absolute rounded-[20px]" />
                ...
                <div className="w-[122px] h-11 relative">
                    ...
                    <div className="left-[26px] top-[14px] absolute text-center text-neutral-100 text-sm font-normal font-['Inter'] leading-none">Explore All</div>
                </div>
            </div>
        </div>)
}
