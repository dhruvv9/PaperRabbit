                ...
                <div className="lg:w-[57%] mac:w-[77%] w-[100%] lg:h-[700px] mac:h-[633px] h-[950px] sm:h-[700px] sm:p-0 relative gap-4 lg:grid lg:grid-cols-2 lg:grid-rows-2 mac:grid-cols-2 mac:grid-rows-2 grid grid-cols-1 grid-rows-4">
                    ...
                    <div className='w-full h-full flex items-end justify-between relative gap-2' >
                        <div className=" w-full h-full flex flex-col items-center justify-center relative m-1">
                            ...
                            <div className="w-full h-full z-10 text-center flex flex-col items-center justify-center  text-black dark:text-white text-[64px] font-normal font-['Katibeh'] leading-[64px]">Lorum ipsum</div>
                        </div>
