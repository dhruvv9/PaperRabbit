    ...
    return (
     ...
     <div className="w-full h-full relative flex flex-col justify-center items-center pt-10 lg:pt-20">
                <div class="w-[24rem] h-[6rem] relative content-center">
                    ...
                    <div class="w-full left-0 top-0 absolute text-black dark:text-white lg:text-[4rem] mac:text-[4rem] text-[2.5rem] font-normal font-['Revelstoke'] leading-[64px] flex flex-col items-center justify-center">About us</div>
                </div>
            </div>
            <div className='lg:w-[56%] mac:w-[74%] w-full flex flex-col items-center justify-center gap-8 mt-10'>
                ...
                <div className='h-full flex items-center justify-center md:flex-col sm:flex-col gap-10 p-8'>
                    <div className="h-full max-w-[400px] text-center text-black dark:text-white text-sm font-normal font-['Inter'] leading-normal">"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. <br /><br />_ DARSHAN PRAKASH</div>
                    ...
                    <div className="max-h-full  max-w-[400px] text-center text-black dark:text-white text-sm font-normal font-['Inter'] leading-normal">"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. <br /><br />_ DARSHAN PRAKASH</div>
                </div>
                <div className="w-full text-justify text-black dark:text-white text-sm font-normal font-['Inter'] leading-normal p-8">
