...
function DummyBanner(props) {
  ...
  return (
    ...
    {currentIndex % 2 === 0 ? <div className="mx-[20px] z-20    absolute flex flex-col items-end justify-start max-w-[583px]  h-[377px] lg:right-[10rem] lg:bottom-[5rem] mac:right-[11%] mac:bottom-[10%] bottom-[10%] lg:absolute sm:relative lg:z-20">
            <div className="w-full h-full absolute  bg-white dark:bg-black bg-opacity-5 dark:bg-opacity-5 rounded-[20px] backdrop-blur-2xl  lg:h-[416px]" />
            <div className="mr-[22px] mt-[15px] sm:mt-[18px] sm:text-[30px] relative  text-black dark:text-white text-[40px] lg:text-[64px] font-normal font-['Katibeh'] lg:sam-[340px] lg:h-[31px] lg:leading-[64px] lg:mt-[30px] lg:mr-[30px] ">What Makes You</div>
            ...
            <div className="mr-[22px] mt-[14px] h-[64px] sam-[120px] lg:sam-[122px] lg:h-11 relative lg:mt-[15px] lg:mr-[30px]">
                <button className="lg:sam-[122px] sam-[120px] h-11  bg-zinc-950 dark:bg-white rounded-[10px] text-center text-white dark:text-black text-xs lg:text-sm font-normal font-['Inter'] leading-none ">Let's Make Art</button>
            </div>
        </div> :

        <div className="mx-[20px]  md:bottom-[10px] md:right-[5px] z-20 sm:relative sm:mb-20 absolute flex flex-col items-end justify-start  sam-[450px] sm:sam-[350px]  sm:h-[350px] lg:sam-[646px] lg:h-[415px] mac:sam-[546px] mac:h-[380px] lg:top-[15rem] lg:bottom-[10rem] mac:left-[15rem] mac:bottom-[6rem] lg:absolute lg:z-20">
            <div className="w-full h-full absolute  bg-white dark:bg-black bg-opacity-5 dark:bg-opacity-5 rounded-[20px] backdrop-blur-2xl lg:sam-[646px] lg:h-[416px]" />
            <div className="mr-[22px] mt-[15px] sm:mt-[18px] sm:text-[30px] relative  text-black dark:text-white text-[40px] lg:text-[64px] font-normal font-['Katibeh'] lg:sam-[340px] lg:h-[31px] lg:leading-[64px] lg:mt-[30px] lg:mr-[30px] ">What Makes You</div>
            <div className="mr-[22px] mt-[6px] sm:mt-[0px] sm:text-[45px] relative text-justify text-black dark:text-white text-5xl leading-18 lg:text-8xl mac:text-7xl font-normal font-['Revelstoke'] lg:leading-[64px] lg:mt-[20px] lg:mr-[30px]">{title[currentIndex]}!</div>
            <div className="mr-[22px] mt-[10px] ml-[20px] sm:text-[14px] relative text-right text-black dark:text-white text-[14px] lg:text-[15px] font-normal font-['Inter'] leading-normal lg:mt-[30px] lg:mr-[30px]">We are barnd enthusiasts. We are storyteller. We are a full service creative agency Combining strategic thinking and sharp design to build great brands in this cut throat business competition.</div>
            ...
            <div className="mr-[22px] mt-[14px] h-[64px] sam-[110px] lg:sam-[122px] lg:h-11 relative lg:mt-[15px] lg:mr-[30px]">
                <button className="lg:sam-[122px] h-11  bg-zinc-950 dark:bg-white rounded-[10px] text-center text-white dark:text-black text-xs lg:text-sm font-normal font-['Inter'] leading-none ">Let's Make Art</button>
            </div>
        </div>
    }
    ...
    {/* <div className="sam-[126px] lg:left-[50%] lg:bottom-[5rem] bottom-[2.5rem] absolute">
