...
function Banner(props) {
    ...
    return (
        <div className="w-[100%] h-screen animate relative flex flex-col items-center justify-end overflow-hidden">
            ...
            {currentIndex % 2 === 0 ? <div className="mx-[20px] z-20 sm:relative sm:mb-12 md:relative md:mb-12 absolute flex flex-col items-end justify-start  w-[450px] sm:w-[90%]  sm:h-[21rem] lg:w-[646px] lg:h-[415px] mac:w-[546px] mac:h-[380px] lg:right-[15rem] lg:bottom-[10rem]  mac:right-52 mac:bottom-[6rem] lg:absolute lg:z-20">
                ...
                <div className="mr-[22px] mt-[6px] sm:mt-[0px] sm:text-[45px] relative text-justify text-black dark:text-white text-5xl lg:text-8xl mac:text-7xl font-normal font-['Revelstoke'] lg:leading-[64px] lg:mt-[20px] lg:mr-[30px]  -top-7 lg:-top-3">{title[currentIndex]}!</div>
                <div className="mr-[22px] mt-[10px] ml-[20px] sm:text-[14px] relative text-right text-black dark:text-white text-[14px] lg:text-[15px] font-normal font-['Inter'] leading-normal lg:mt-[30px] lg:mr-[30px]  -top-6  lg:-top-3">We are barnd enthusiasts. We are storyteller. We are a full service creative agency Combining strategic thinking and sharp design to build great brands in this cut throat business competition.</div>

                <div className="mr-[22px] mt-[10px] sm:text-[30px] relative text-justify text-black dark:text-white text-[32px] font-normal font-['Heaven'] leading-normal lg:text-5xl  lg:mt-[15px] lg:mr-[30px] -top-6 lg:-top-0"># What makes you creative</div>

                <div className="mr-[22px] mt-[14px] h-[64px] w-[120px] lg:w-[122px] lg:h-11 relative lg:mt-[15px] lg:mr-[30px] -top-7 lg:-top-0">
                ...
                <div className="mx-[20px] z-20 sm:relative sm:mb-12 md:relative md:mb-12 absolute flex flex-col items-start justify-start  w-[450px] sm:w-[90%]  sm:h-[21rem] lg:w-[646px] lg:h-[415px] mac:w-[546px] mac:h-[380px] lg:left-[15rem] lg:bottom-[10rem]  mac:left-52 mac:bottom-[6rem] lg:absolute lg:z-20">
                <div className="w-full h-full absolute  bg-white dark:bg-black bg-opacity-5 dark:bg-opacity-5 rounded-[20px] backdrop-blur-2xl lg:w-[646px] lg:h-[416px]" />
                <div className="ml-[22px] mt-[15px] sm:mt-[18px] sm:text-[40px] relative  text-black dark:text-white text-[40px] lg:text-[64px] font-normal font-['Katibeh'] lg:w-[340px] lg:h-[31px] lg:leading-[64px] lg:mt-[30px] lg:mr-[30px] ">What Makes You</div>
                <div className="ml-[22px] mt-[6px] sm:mt-[0px] sm:text-[45px] relative text-justify text-black dark:text-white text-5xl lg:text-8xl mac:text-7xl font-normal font-['Revelstoke'] lg:leading-[64px] lg:mt-[20px] lg:mr-[30px]  -top-7 lg:-top-3">{title[currentIndex]}!</div>
                <div className="ml-[22px] mt-[10px] mr-[20px] sm:text-[14px] relative text-left text-black dark:text-white text-[14px] lg:text-[15px] font-normal font-['Inter'] leading-normal lg:mt-[30px] lg:mr-[30px]  -top-6  lg:-top-3">We are barnd enthusiasts. We are storyteller. We are a full service creative agency Combining strategic thinking and sharp design to build great brands in this cut throat business competition.</div>

                <div className="ml-[22px] mt-[10px] sm:text-[30px] relative text-justify text-black dark:text-white text-[32px] font-normal font-['Heaven'] leading-normal lg:text-5xl  lg:mt-[15px] lg:mr-[30px] -top-6 lg:-top-0"># What makes you creative</div>

                <div className="ml-[22px] mt-[14px] h-[64px] w-[120px] lg:w-[122px] lg:h-11 relative lg:mt-[15px] lg:mr-[30px] -top-7 lg:-top-0">
                    <button className="lg:w-[122px] w-[120px] h-11  bg-zinc-950 dark:bg-white rounded-[10px] text-center text-white dark:text-black text-xs lg:text-sm font-normal font-['Inter'] leading-none ">Let's Make Art</button>
                </div>
            </div> 
            }
