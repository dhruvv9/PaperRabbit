  ...
  return (
    <div class="w-full h-80 flex justify-center items-center mt-20 ">
      <div class="lg:w-[1420px] lg:h-80 w-full h-80 relative mx-5 my-8 text-center flex flex-col lg:flex-row items-center lg:justify-between justify-center ">
        ...
        <div className="lg:w-full lg:h-full lg:pl-[60px] flex flex-col justify-center  gap-3 my-10 lg:text-left text-2xl relative text-white dark:text-black lg:text-[40px] font-bold font-['Inter'] leading-none lg:leading-[48px]">
        ...
        <div className="relative flex flex-col items-center justify-center gap-4">
          <button class="lg:w-[122px] lg:h-[44px] lg:mr-[100px] relative text-xs bg-zinc-950 dark:bg-white rounded-[10px] text-white dark:text-black lg:text-sm font-bold font-['Inter'] leading-[30px] justify-center items-center inline-flex">
            Work with US
          </button>
          <button class=" lg:w-[122px] lg:h-[44px] lg:mr-[100px] relative text-xs bg-zinc-950 dark:bg-white rounded-[10px] text-white dark:text-black lg:text-sm font-bold font-['Inter'] leading-[30px] justify-center items-center inline-flex block-bg">
            Work with US
          </button>
        </div>
      </div>
