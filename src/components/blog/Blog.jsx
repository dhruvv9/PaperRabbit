    ...
    return (
        <div className="w-full h-[70%] relative flex flex-col items-center justify-start mt-10 lg:mt-20 ">
            ...
            <div className="w-full h-full  relative flex items-start gap-5 overflow-x-scroll no-scrollbar my-12 ">
                ...
                <div className="w-full ml-[20px] lg:ml-[570px]  h-[420px] lg:h-[600px] relative flex flex-col justify-end items-start ">
                    <img className="w-[197px] lg:w-[340px] h-[420px] lg:h-[598px] left-0 top-0 absolute -z-20 rounded-[20px]" src={services0} alt='' />

                    <div className="absolute top-0 left-0 w-10 h-10 lg:w-20 lg:h-20 flex flex-col items-center justify-center text-[12px] lg:text-[32px] font-bold font-['Inter'] rounded-tl-[20px] rounded-br-[20px] backdrop-blur-[20px]">
                        <div className='w-full h-full absolute -z-10 rounded-tl-[20px] rounded-br-[20px] backdrop-blur-[20px' />
                        334
                    </div>

                    <div className="w-[197px] lg:w-[340px] lg:h-[258px] h-[220px] relative rounded-[20px] flex flex-col justify-center items-start gap-2 group/items ">
                        <div className="w-[197px] lg:w-[340px] h-[258px] relative rounded-[20px] flex flex-col justify-center items-start gap-2.5 group-hover/items:invisible">
                        ...
                        <div className="w-full h-[420px] lg:h-[600px] lg:top-[-21.5rem] top-[-12.5rem] absolute rounded-[20px] z-10 flex flex-col justify-center items-start gap-2 invisible group-hover/items:visible ">
                            ...
                            <div className="text-justify text-black text-[10px] lg:text-sm font-normal font-['Inter'] lg:leading-[30px] leading-[20px] lg:p-3 p-1 ">
                                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Tempor incididunt ut labore et dolore magna aliqua. "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Tempor incididunt ut labore et.                                </div>
