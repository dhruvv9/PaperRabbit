...
function BlogCards() {
    return (
        ...
        <div className="w-[197px] lg:w-[340px] mac:w-[340px] lg:h-[258px] mac:h-[258px] h-[220px] relative rounded-[20px] flex flex-col justify-center items-start gap-2 group/items ">
            ...
            <div className="w-full h-[420px] lg:h-[600px] mac:h-[600px] lg:top-[-21.5rem] mac:top-[-21.5rem] top-[-12.5rem] absolute rounded-[20px] z-10 flex flex-col justify-center items-start gap-2 invisible group-hover/items:visible ">
                <div className='w-full h-full absolute -z-10 rounded-[20px] bg-transparent backdrop-blur-2xl bg-gray-50' />
                ...
                <div className="text-justify text-black text-[10px] lg:text-sm mac:text-sm font-normal font-['Inter'] lg:leading-[30px] mac:leading-[30px] leading-[20px] lg:p-3 mac:p-3 p-1 ">
