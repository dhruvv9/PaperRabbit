...
function DummyServices() {
    return (
        <div className="w-full z-20  relative flex flex-col items-center justify-start  ">
            ...
            <div className="w-full relative flex items-start gap-5 overflow-x-scroll no-scrollbar my-12 mt-20  no-scrollbar  flex-row ">

                <div className="sm:min-w-[197px] xl:min-w-[19rem] ml-[20px] lg:ml-[570px] mac:ml-[233px]  relative">
                    <img className=" relative rounded-[20px]" src={services0} alt='' />
                    <div className=" w-full pl-2 md:pl-6 md:pr-[35px] py-10 top-0 absolute rounded-[20px] flex-col justify-center items-start gap-2.5 inline-flex">
                        ...
                        <div className=" text-zinc-950 text-base md:text-2xl font-bold font-['Inter'] leading-normal">Perspiciati lorum ipsum</div>                            <div className="self-stretch h-4 relative">
                    ...
                    {/* <img className=" right-2 bottom-2 lg:left-[278px] lg:top-[538px] absolute backdrop-blur-[20px] rounded-full" src={add} alt='' /> */}
                </div>
                <div className="sm:min-w-[197px] xl:min-w-[19rem] relative">
                    <img className="  rounded-[20px]" src={services0} alt='' />
                    <div className=" w-full pl-2 md:pl-6 md:pr-[35px] py-10 top-0 absolute rounded-[20px] flex-col justify-center items-start gap-2.5 inline-flex">
                        <div className="text-zinc-950 text-xs md:text-sm font-normal font-['Inter'] leading-none">Lorum Ipsum</div>
                        <div className=" text-zinc-950 text-base md:text-2xl font-bold font-['Inter'] leading-normal">Perspiciati lorum ipsum</div>                            <div className="self-stretch h-4 relative">
                            <div className="left-[15px] top-0 absolute text-zinc-950 text-xs md:text-sm font-medium font-['Inter'] leading-none">Explore</div>
                    ...
                    {/* <img className=" right-2 bottom-2  absolute backdrop-blur-[20px] rounded-full" src={add} alt='' /> */}
                </div>

                <div className="sm:min-w-[197px] xl:min-w-[19rem] relative">
                    <img className="left-0 top-0  rounded-[20px]" src={services0} alt='' />
                    <div className=" w-full pl-2 md:pl-6 md:pr-[35px] py-10 top-0 absolute rounded-[20px] flex-col justify-center items-start gap-2.5 inline-flex">
                        <div className="text-zinc-950 text-xs md:text-sm font-normal font-['Inter'] leading-none">Lorum Ipsum</div>
                        <div className=" text-zinc-950 text-base md:text-2xl font-bold font-['Inter'] leading-normal">Perspiciati lorum ipsum</div>                            <div className="self-stretch h-4 relative">
                            <div className="left-[15px] top-0 absolute text-zinc-950 text-xs md:text-sm font-medium font-['Inter'] leading-none">Explore</div>
                    ...
                    {/* <img className=" right-2 bottom-2  absolute backdrop-blur-[20px] rounded-full" src={add} alt='' /> */}
                </div>                <div className="sm:min-w-[197px] xl:min-w-[19rem] relative">
                    <img className="left-0 top-0  rounded-[20px]" src={services0} alt='' />
                    <div className=" w-full pl-2 md:pl-6 md:pr-[35px] py-10 top-0 absolute rounded-[20px] flex-col justify-center items-start gap-2.5 inline-flex">
                        <div className="text-zinc-950 text-xs md:text-sm font-normal font-['Inter'] leading-none">Lorum Ipsum</div>
                        <div className=" text-zinc-950 text-base md:text-2xl font-bold font-['Inter'] leading-normal">Perspiciati lorum ipsum</div>                            <div className="self-stretch h-4 relative">
