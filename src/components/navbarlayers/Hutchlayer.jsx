...
function Hutchlayer() {
    return (
        ...
        <div className='w-screen h-[700rem] flex flex-items-center relative bg-neutral-100'>
            ...
            <div className=' grid grid-cols-1 justify-center items-center h-[300rem] w-[1420px] mt-[60rem] ml-[600px] '>
                ...
                <img className="w-[full ]  top-[0]  lg:w-[1420px] lg:h-[500px]  lg:top-[0rem] relative " src={bannerimg} alt='' />
