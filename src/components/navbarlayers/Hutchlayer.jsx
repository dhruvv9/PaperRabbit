    ...
    return (
        ...
        <div className='w-full h-[] flex flex-items-center relative bg-neutral-100'>
            ...
            <div className=' flex flex-col justify-center items-center h-[370rem] mac:w-[100%] lg:w-[56%]   w-screen mt-[10rem] lg:ml-[37rem] '>
                ...
                <div className='grid gap-[5rem] lg:gap-[8rem] w-[70%] lg:w-[100%] mt-[5rem] lg:grid-cols-4  grid-col-1  mac:grid-cols-2  items-center relative'>

                    <div className='w-[100%] lg:w-[140%]  h-[876px] flex-item-center bg-gray-50 bg-opacity-20 rounded-[20px] border border-black backdrop-blur-[20px] relative'>
