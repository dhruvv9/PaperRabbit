...
function ServicesContent({name}) {
    console.log();
    return (
        <div className="lg:w-[55%] mac:w-[70%] w-full h-full relative flex flex-col lg:flex-row mac:flex-row justify-center items-center lg:p-0 p-3 " >
            <div className="" >
                <img className="w-full h-full relative rounded-[20px]" src={servicesImage} alt="services" />
            </div>

            <div className="lg:w-[50%] lg:h-[31rem] w-full h-full relative flex flex-col items-center justify-start gap-5 lg:ml-[1.2rem] m-2 mac:m-4" >
