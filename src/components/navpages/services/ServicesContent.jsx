...
function ServicesContent() {
    return (
        <div className="lg:w-[88rem] w-screen h-full flex flex-col lg:flex-row justify-center items-center lg:p-0 p-3" >
        <div className="" >
            <img className="w-[43rem] h-[31rem] rounded-[20px]" src={servicesImage} alt="services" />
        </div>
    
        <div className="lg:w-[50%] lg:h-[31rem] w-full h-full flex flex-col items-center justify-start gap-5 ml-[1.2rem] " >
