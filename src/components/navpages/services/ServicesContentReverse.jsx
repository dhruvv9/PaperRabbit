...
function ServicesContentReverse({name}) {
  return (
    <div className="lg:w-[55%] mac:w-[70%] w-full h-full relative flex flex-col lg:flex-row-reverse mac:flex-row-reverse justify-center items-center lg:p-0 p-3 " >
    <div className="" >
        <img className="w-full h-full relative rounded-[20px]" src={servicesImage} alt="services" />
    </div>

    <div className="lg:w-[50%] lg:h-[31rem] w-full h-full relative flex flex-col items-center justify-start gap-5 lg:mr-[1.2rem] m-2 mac:m-4" >
        <div className="flex flex-col items-center justify-center relative text-black text-2xl mac:text-xl font-bold font-['Inter'] leading-normal ">
            {name ? name : 'none'}
        </div>
        <div className="flex flex-col items-center justify-center relative text-black text-xs font-bold font-['Inter'] leading-3">
            Lorem ipsum dolor sit amet.
        </div>
        <div className="flex flex-col items-center justifypaper-center relative text-justify text-black text-sm mac:text-xs font-normal font-['Inter'] leading-normal">
        ...
        <div className=" w-full h-full flex items-center justify-evenly relative">
            <div className="h-full gap-8 mac:gap-4 flex flex-col items-center text-black relative lg:text-xs text-xs font-bold font-['Inter'] leading-3">
