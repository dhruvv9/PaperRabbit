...
function HutchPage() {
    return (
        <div className='w-screen flex flex-col items-center justify-center place-content'>
            <div className='lg:w-[57%] w-screen h-full grid lg:grid-cols-4 lg:grid-rows-2 mac:grid-cols-2 mac:grid-rows-4  grid-rows-4 grid-cols-1 items-center justify-center'>
                <HutchPageCards/>
                <HutchPageCards2/>
                <HutchPageCards/>
                <HutchPageCards2/>
