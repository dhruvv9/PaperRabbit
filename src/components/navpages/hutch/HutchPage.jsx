...
function HutchPage() {
    return (
        <div className='w-full flex flex-col items-center justify-center place-content'>
            <div className='lg:w-[57%] mac:w-[70%] w-full h-full grid lg:grid-cols-4 lg:grid-rows-2 mac:grid-cols-4 mac:grid-rows-2 grid-cols-2 grid-rows-4 items-center justify-center gap-4'>
                <HutchPageCards/>
                <HutchPageCards2/>
                <HutchPageCards/>
                <HutchPageCards2/>
