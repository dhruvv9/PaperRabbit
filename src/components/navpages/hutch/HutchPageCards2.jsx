...
function HutchPageCards2() {
    return (
        <div className="w-full h-[420px] lg:h-[600px] mac:h-[600px] relative flex flex-col justify-end items-center mt-40">
            ...
            <div className="w-[190px] lg:w-[340px] mac:w-[340px] lg:h-[258px] mac:h-[258px] h-[220px] relative rounded-[20px] flex flex-col justify-center items-center gap-2 group/items ">
