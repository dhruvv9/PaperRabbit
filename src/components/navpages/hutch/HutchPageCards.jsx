...
function HutchPageCards() {
    return (
        <div className="w-full h-[460px] lg:h-[600px] relative flex flex-col justify-end items-center">
        ...
        <div className="w-[280px] lg:w-[340px]  lg:h-[258px]  h-[120px] relative rounded-[20px] flex flex-col justify-center items-center gap-2 group/items ">
            <div className="w-[280px] lg:w-80  h-[218px] relative rounded-[20px] flex flex-col justify-center items-center gap-2.5 ">
                <div className='w-full h-full absolute -z-10 bg-gray-50 bg-opacity-20 rounded-2xl backdrop-blur-[20px]' />
                <div class="flex items-center justify-center text-black lg:text-2xl mac:text-xl font-bold font-['Inter'] leading-loose text-sm ">Perspiciatis unde omrs</div>
