...
function HutchPageCards() {
    return (
        <div className="min-w-[260px] max-w-[360px] relative  mx-auto ">
        <img className="w-full relative -z-20 rounded-[20px]" src={services0} alt='' />

        <div className="h-[220px] m-1  absolute bottom-0 rounded-[20px] flex flex-col justify-center items-center gap-2 group/items ">
