    ...
    return (
        <div className="w-full lg:h-full relative flex flex-col items-center justify-center gap-10 mt-10 lg:mt-20">
            ...
            <div
                ...
                class="w-screen h-[220px] lg:w-[55%] lg:mt-20 relative inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_left,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]"
            >
