            ...
            >
                <ul x-ref="logos" class="h-full flex items-center justify-center md:justify-start [&_li]:mx-8 [&_img]:max-w-none animate-infinite-scroll">
                    <li className='group/items' >
                        <img className="w-[135px] h-[53px] group-hover/items:invisible " src={client1} alt="client1" />
                        <img className='invisible group-hover/items:visible' src={client10} alt="client2" />
                    </li>
                    <li>
