...
function PodcastCards({ podcastimg }) {
    return (
        <div className="w-full  h-[542px] lg:h-[600px] relative flex flex-col justify-end items-start ">
            <img className="w-[306px] lg:w-[340px]  h-[542px] lg:h-[598px] left-0 top-0 absolute  rounded-[20px]" src={podcastimg} alt='' />
