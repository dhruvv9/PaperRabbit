    ...
    return (
        <div className="w-full h-[70%] relative flex flex-col items-center justify-start mt-10 lg:mt-20 ">
            ...
            <div className="w-full h-fit relative flex items-start gap-5 overflow-x-scroll no-scrollbar mt-20 ">
                ...
                <div className="w-full ml-[20px] lg:ml-[570px] mac:ml-[232px] h-[542px] lg:h-[600px] relative flex flex-col justify-end items-start ">
                    <img className="w-[306px] lg:w-[340px]  h-[542px] lg:h-[598px] left-0 top-0 absolute  rounded-[20px]" src={podcastimg1} alt='' />
                    ...
                    <div className="w-[306px] lg:w-[340px] z-20 lg:h-[205px] h-[180px] relative rounded-[20px] flex flex-col justify-center items-start gap-2 group/items ">
                        <div className="w-[306px] lg:w-[340px] z-20 lg:h-[205px]  h-[180px] relative rounded-[20px] flex flex-col justify-center items-start gap-2.5">
